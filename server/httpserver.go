...
import (
	...
	"github.com/smonkeymonkey/marathon_runners/controllers"
...
func InitHttpServer(config *viper.Viper, dbHandler *sql.DB) HttpServer {
	...
	usersReposittory := repositories.NewUsersRepository(dbHandler)
	...
	usersService := services.NewUsersService(usersReposittory)
